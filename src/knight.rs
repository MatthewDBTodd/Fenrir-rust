...
pub fn init() -> Vec<u64> {
    ...
    for _ in 0..64 {
        let n = mask
            | north_north_west!(mask) & NOT_H_FILE
            | north_west_west!(mask) & NOT_G_H_FILE
            | south_south_west!(mask) & NOT_H_FILE
            | south_west_west!(mask) & NOT_G_H_FILE
            | north_north_east!(mask) & NOT_A_FILE
            | north_east_east!(mask) & NOT_A_B_FILE
            | south_south_east!(mask) & NOT_A_FILE
            | south_east_east!(mask) & NOT_A_B_FILE;
